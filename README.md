...
```
cd existing_repo
git remote add origin https://gitlab.similarweb.io/infrastructure/bbox.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.similarweb.io/infrastructure/bbox/-/settings/integrations)
